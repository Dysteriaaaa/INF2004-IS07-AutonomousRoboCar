...
> the fastest way to destroy a Pico on this project. Schematic and a
> breadboard layout: `docs/img/hw/hcsr04_divider.png` (generated by
> `gen_hcsr04_divider.py`); the buddy 5 guide has the step list.
